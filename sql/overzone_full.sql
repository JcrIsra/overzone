...
INSERT INTO usuarios (nombre, clave, correo, edad, genero, skin, x, y, z, a, dinero, coins, licenses, nivel, exp, created_at, last_login, vida, chaleco, sed, hambre, admin)
VALUES
('TestUser', '12345', 'test@example.com', 25, 0, 60, 0.0, 0.0, 3.0, 0.0, 1000000, 10, 0, 1, 0, NOW(), NOW(), 100.0, 0.0, 0, 0, 5),
('Player1', 'password', 'player1@vzla.test', 30, 0, 60, 245.0, -1700.0, 13.0, 0.0, 500000, 2, 1, 1, 0, NOW(), NOW(), 100.0, 0.0, 0, 0, 0);
